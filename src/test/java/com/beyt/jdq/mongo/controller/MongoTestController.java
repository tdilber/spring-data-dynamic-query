...
public class MongoTestController {
     ...
     * Example: /mongo-test-api/customer?key0=age&operation0=EQUAL&values0=24
     */
    @GetMapping("/customer")
     ...
     * Example: /mongo-test-api/user?key0=status&operation0=EQUAL&values0=ACTIVE
     */
    @GetMapping("/user")
     ...
     * Example: /mongo-test-api/user/as-page?key0=status&operation0=EQUAL&values0=ACTIVE&page=0&pageSize=10
     */
     ...
     * Example: /mongo-test-api/customer/as-list?select0=name&select1=age&page=0&pageSize=10
     */
     ...
     * Example: /mongo-test-api/user/as-list?select0=name&select1=surname&select2=birthdate&page=0&pageSize=2
     */
     ...
     * Example: /mongo-test-api/customer/as-page?key0=age&operation0=GREATER_THAN&values0=23&page=0&pageSize=5
     */
