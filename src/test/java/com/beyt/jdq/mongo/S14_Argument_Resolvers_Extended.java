...
/**
 * MongoDB tests for argument resolvers (CriteriaList and DynamicQuery).
 * Tests REST endpoints that automatically resolve query parameters to criteria objects.
 */
...
public class S14_Argument_Resolvers_Extended extends BaseMongoTestInstance {
