...
/**
 * MongoDB tests for DynamicQueryManager functionality.
 * Tests complex query scenarios, projections, pagination, and JdqModel annotations.
 */
@SpringBootTest(classes = MongoTestApplication.class)
@ActiveProfiles("mongotest")
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_CLASS)
class S12_Dynamic_Query_Manager extends BaseMongoTestInstance {
